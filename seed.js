...
seeder.connect('mongodb+srv://bwamern:bwamern@cluster0.dqooa.mongodb.net/db_staycation?retryWrites=true&w=majority', {
  ...
  seeder.clearModels(['Category', 'Activity', 'Bank', 'Item', 'Member', 'Item', 'Feature', 'Image', 'Booking', 'Users'], function () {
