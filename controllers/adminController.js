...
module.exports = {
    ...
    editCategory : async (req, res) => {
        try {
            ...
            category.name = name;
            await category.save();
            req.flash('alertMessage', 'Updated Success');
            req.flash('alertStatus', 'success');
            res.redirect('/admin/category');
        } catch (error) {
            req.flash('alertMessage', `${error.message}`);
    ...
    viewDetailItem : async (req, res) => {
        ...
        try {
            ...
            res.render('admin/item/detail_items/view_detail_item', {
    ...
    actionConfirmation : async (req, res) => {
        ...
        try {
            ...
            await booking.save();
            req.flash('alertMessage', 'Confirmation Accepted');
            req.flash('alertStatus', 'success');
            res.redirect('/admin/booking/');
        } catch (error) {
            req.flash('alertMessage', `${error.message}`);
    ...
    actionRejection : async (req, res) => {
        ...
        try {
            ...
            await booking.save();
            req.flash('alertMessage', 'Confirmation Reject');
            req.flash('alertStatus', 'success');
            res.redirect('/admin/booking/');
        } catch (error) {
            req.flash('alertMessage', `${error.message}`);
